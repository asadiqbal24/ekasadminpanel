...
Route::middleware([AdminMiddleware::class])->group(function () {
    ...
    Route::delete('/notification-delete/{id}', [NotificationController::class, 'Notificationdelete'])->name('notification-delete');
    Route::delete('/notification-delete/{id}', [NotificationController::class, 'Notificationdelete'])->name('notification-delete');
...
Route::get('/subscribers', [UserManagement::class, 'getSubscribers'])->name('subscribers');
Route::get('/subscribers-list', [UserManagement::class,'subscribersList'])->name('subscribersList');
...
Route::prefix('stripe/')->controller(StripeController::class)->group(function () {
    ...
    Route::get('payments/list', 'paymentsList')->name('get.paymentsList');
...
Route::get('get/sessions', [SessionsController::class, 'index'])->name('session.index');
// Route::get('session-list', 'sessionList')->name('get.sessionList');

Route::get('add/{package}', [SessionsController::class, 'create'])->name('session.create');
Route::post('add/{name}', [SessionsController::class, 'store'])->name('session.store');
Route::get('delete/session/{id}/{source}', [SessionsController::class, 'delete'])->name('session.delete');
Route::get('edit/session/{id}/{source}', [SessionsController::class, 'edit'])->name('session.edit');
Route::post('update/session/{id}/{source}', [SessionsController::class, 'update'])->name('session.update');


Route::get('viewblogs', [BlogController::class, 'index'])->name('blog.index');
    ...
    Route::post('store/blog/category', [BlogCategoryController::class, 'store'])->name('blog.category.store');
    Route::get('delete/blog/category/{id}', [BlogCategoryController::class, 'destroy'])->name('blog.category.delete');
    ...
    Route::get('get/feedbacks', [FeedbackController::class, 'index'])->name('feedback.view');
    Route::get('add/feedback', [FeedbackController::class, 'create'])->name('feedback.create');
    Route::post('feedback/store', [FeedbackController::class, 'store'])->name('feedback.store');
    Route::get('view/feedback/{id}', [FeedbackController::class, 'view'])->name('feedback.show');
    Route::get('delete/feedback/{id}', [FeedbackController::class, 'delete'])->name('feedback.delete');
...
//Get route, copy method and view
//Post method and copy logic
...
// Route::post('/auth/login', [LoginBasic::class, 'index'])->name('auth-login-basic');
